    ...
    <div className="flex flex-col gap-1">
      ...
      <input
        ...
        className={`
          ...
          outline-none transition-all duration-200 text-sm hover:border-slate-500
      ...
      <div style={{ animation: "slideUp 0.4s ease both" }} className="w-full max-w-md">
        ...
        <div className="bg-slate-900/80 backdrop-blur border border-slate-800 rounded-2xl shadow-2xl shadow-black/40 p-8">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl bg-white text-slate-900 text-sm font-semibold hover:bg-slate-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed mb-5"
          >
        ...
        <p className="text-center text-sm text-slate-500 mt-6">
          ...
          <a href="/register" className="text-indigo-400 hover:text-indigo-300 font-medium transition-colors underline underline-offset-2">
            Register
          </a>
        </p>
      </div>
